...
public class Base extends CommonActions{
	...
	public void initSetup(){
		eReports = new ExtentReports("C:\\AugustReports\\Html\\Reports_" + getDatetimeStamp() + ".html");		
	}
	...
	public void launchAPP(String brow){
		...
		else if(brow.equalsIgnoreCase("ch"))
		{
...
//	capture screenshot
	public String fullscreen() throws Exception{
		...
		String path = "C:\\screenshotss\\s1_" + getDatetimeStamp() + ".png";
